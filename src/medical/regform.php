    ...
    <div class="col-4">
      ...
      <form method="post" action="<?php echo $baseName . "reg.php"; ?>" enctype="multipart/form-data">
        <div class="mb-3">
          ...
          <input type="file" class="form-control" name="logoimg" placeholder="Select your image"
            aria-describedby="fileHelpId">
          <div id="fileHelpId" class="form-text">Help text</div>
        </div>
        <div class="form-floating mb-3">
          <input type="text" class="form-control" name="medid" placeholder="name">
        ...
        <div class="form-floating mb-3">
          <input type="password" class="form-control" name="pass" placeholder="name">
          <label for="formId1">Password</label>
        </div>
        <div class="form-floating mb-3">
          <input type="text" class="form-control" name="spec" placeholder="name">
